...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["do-do-module"], {
  ...
  /***/
  function srcAppDoDoComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DoComponent", function () {
      return DoComponent;
    });
    /* harmony import */
    ...
    var DoComponent = function DoComponent() {
      _classCallCheck(this, DoComponent);
    };

    DoComponent.ɵfac = function DoComponent_Factory(t) {
      return new (t || DoComponent)();
    };

    DoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: DoComponent,
      selectors: [["do-example"]],
      decls: 3,
      vars: 0,
      consts: [[1, "two-across"]],
      template: function DoComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DoComponent, [{
  ...
  /***/
  function srcAppDoDoModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DoModule", function () {
      return DoModule;
    });
    /* harmony import */
    ...
    var _do_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./do.component */
    "./src/app/do/do.component.ts");
    /* harmony import */
    ...
    var doRoutes = [{
      path: '',
      component: _do_component__WEBPACK_IMPORTED_MODULE_4__["DoComponent"]
    }];

    var DoModule = function DoModule() {
      _classCallCheck(this, DoModule);
    };

    DoModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: DoModule
    });
    DoModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function DoModule_Factory(t) {
        return new (t || DoModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(doRoutes), _shared_module_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"]]]
    });
    /*@__PURE__*/

    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](DoModule, {
      declarations: [_employee_list_employee_list_component__WEBPACK_IMPORTED_MODULE_5__["EmployeeListComponent"], _position_list_position_list_component__WEBPACK_IMPORTED_MODULE_6__["PositionListComponent"], _do_component__WEBPACK_IMPORTED_MODULE_4__["DoComponent"]],
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](DoModule, [{
  ...
  /***/
  function srcAppDoEmployeeListEmployeeListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppDoPositionListPositionListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
...
//# sourceMappingURL=do-do-module-es5.js.map