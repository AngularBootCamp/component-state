...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dont-dont-module"], {
  ...
  /***/
  function srcAppDontDontComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DontComponent", function () {
      return DontComponent;
    });
    /* harmony import */
    ...
    var _position_list_position_list_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    */
    ...
    /*#__PURE__*/
    function () {
      function DontComponent() {
        _classCallCheck(this, DontComponent);

        this.currentEmployees = ['Alice Anderson', 'Billy Burton', 'Carol Carson', 'David Dennison'];
        this.newEmployees = ['Erin Ericcson', 'Frank Ferdinand'];
        this.currentPositions = ['Copier', 'Secretary to Customer Design Spec Engineer', 'Tester', 'Phone Bank Worker'];
        this.newPositions = ['Manager', 'Break Room Attendant'];
      }

      _createClass(DontComponent, [{
        key: "ackPosition",
        value: function ackPosition(position) {
          this.newPositions = this.newPositions.filter(function (curPosition) {
        ...
        value: function ackEmployee(employee) {
          this.newEmployees = this.newEmployees.filter(function (curEmployee) {
        ...
        value: function ackAll() {
          ...
          this.newPositions.forEach(function (pos) {
            return _this.currentPositions.push(pos);
          });
          this.newPositions = [];
          this.newEmployees.forEach(function (emp) {
            return _this.currentEmployees.push(emp);
          });
          this.newEmployees = [];
        }
      }]);
    ...
    DontComponent.ɵfac = function DontComponent_Factory(t) {
      return new (t || DontComponent)();
    };

    DontComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: DontComponent,
      selectors: [["dont-example"]],
      decls: 5,
      vars: 4,
      consts: [[1, "two-across"], [3, "curEmployees", "newEmployees", "ackEmployee"], [3, "curPositions", "newPositions", "ackPosition"], [1, "btn", 3, "click"]],
      template: function DontComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "employee-list", 1);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ackEmployee", function DontComponent_Template_employee_list_ackEmployee_1_listener($event) {
            return ctx.ackEmployee($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ackPosition", function DontComponent_Template_position_list_ackPosition_2_listener($event) {
            return ctx.ackPosition($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DontComponent_Template_button_click_3_listener($event) {
            return ctx.ackAll();
          });
      ...
      directives: [_employee_list_employee_list_component__WEBPACK_IMPORTED_MODULE_1__["EmployeeListComponent"], _position_list_position_list_component__WEBPACK_IMPORTED_MODULE_2__["PositionListComponent"]],
      encapsulation: 2
    });
    /*@__PURE__*/

    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DontComponent, [{
  ...
  /***/
  function srcAppDontDontModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DontModule", function () {
      return DontModule;
    });
    /* harmony import */
    ...
    var _dont_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./dont.component */
    "./src/app/dont/dont.component.ts");
    /* harmony import */
    ...
    var dontRoutes = [{
      path: '',
      component: _dont_component__WEBPACK_IMPORTED_MODULE_4__["DontComponent"]
    }];

    var DontModule = function DontModule() {
      _classCallCheck(this, DontModule);
    };

    DontModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: DontModule
    });
    DontModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function DontModule_Factory(t) {
        return new (t || DontModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(dontRoutes), _shared_module_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"]]]
    });
    /*@__PURE__*/

    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](DontModule, {
      declarations: [_employee_list_employee_list_component__WEBPACK_IMPORTED_MODULE_5__["EmployeeListComponent"], _position_list_position_list_component__WEBPACK_IMPORTED_MODULE_6__["PositionListComponent"], _dont_component__WEBPACK_IMPORTED_MODULE_4__["DontComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"], _shared_module_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"]]
    });
    /*@__PURE__*/


    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](DontModule, [{
  ...
  /***/
  function srcAppDontEmployeeListEmployeeListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _shared_module_current_employees_current_employees_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var _shared_module_new_employees_new_employees_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    EmployeeListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function EmployeeListComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ackEmployee", function EmployeeListComponent_Template_new_employees_ackEmployee_9_listener($event) {
      ...
      directives: [_shared_module_current_employees_current_employees_component__WEBPACK_IMPORTED_MODULE_1__["CurrentEmployeesComponent"], _shared_module_new_employees_new_employees_component__WEBPACK_IMPORTED_MODULE_2__["NewEmployeesComponent"]],
      encapsulation: 2
    });
    /*@__PURE__*/
  ...
  /***/
  function srcAppDontPositionListPositionListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _shared_module_current_positions_current_positions_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var _shared_module_new_positions_new_positions_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    */
    ...
    PositionListComponent.ɵfac = function PositionListComponent_Factory(t) {
      return new (t || PositionListComponent)();
    };
    ...
    PositionListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function PositionListComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ackPositions", function PositionListComponent_Template_new_positions_ackPositions_9_listener($event) {
      ...
      directives: [_shared_module_current_positions_current_positions_component__WEBPACK_IMPORTED_MODULE_1__["CurrentPositionsComponent"], _shared_module_new_positions_new_positions_component__WEBPACK_IMPORTED_MODULE_2__["NewPositionsComponent"]],
      encapsulation: 2
    });
    /*@__PURE__*/
...
//# sourceMappingURL=dont-dont-module-es5.js.map